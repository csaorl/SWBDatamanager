...
public class Encryptor
{
    ...
    public static void main(String args[])
    {
        ...
        Encryptor t = new Encryptor(keyString);

        String src = "Hola Mundo!";
        System.out.println("input = [" + src + "]");
    ...
    /**
     * 
     * @param keyString hexadecimal string from 16 bytes
     * example: "05fe858d86df4b909a8c87cb8d9ad596"
     */
...
// Display the resulting decoded string, trimmed.to remove padding.
        int x;
        for(x=dec.length-1;x>=0;x--)
        {
            if(dec[x]!=0)break;
        }
        return new String(dec,0,x+1);
    }
