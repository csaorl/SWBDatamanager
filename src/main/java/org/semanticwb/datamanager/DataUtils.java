...
public class DataUtils {
    ...
    {   
        ...
        {
            return httpPOST(url, params, null, 0);
        }        
        
        public static String httpPOST(String url, String data, String contentType) throws IOException
        {
            return httpPOST(url, data, contentType, 0);
        }        
                
        public static String httpPOST(String url, String data, String contentType, int timeout) throws IOException
        {
            ...
            return DataUtils.readInputStream(conn.getInputStream(), "UTF-8");
        }
